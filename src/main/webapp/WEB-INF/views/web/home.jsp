						...
						<div class="col-lg-3">
							<div class="product__discount__item">
								...
								<div class="product__discount__item__text">
									<span>thể loại</span>
									<h5>
										<a  href='<c:url value = "/san-pham?code=${item.code }"/>'>${item.name }</a>
									</h5>
					...
					<div class="latest-product__text">
						...
						<div class="latest-product__slider owl-carousel">
							...
							<c:forEach var="item" items="${model.listLatest}" >
								<a href='<c:url value = "/san-pham?code=${item.code }"/>' class="latest-product__item">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="blog__item">
							...
							<div class="blog__item__text">
								...
								<h5>
									<a href='<c:url value = "/bai-viet?code=${item.code }"/>'>${item.title }</a>
								</h5>
